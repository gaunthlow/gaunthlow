...
AddEventHandler("crew:onPlayerLoaded",function(a)
    ...
    getOrGeneratePhoneNumber(b,c,function(phoneNumber)
		TriggerClientEvent("crew:updatePhone",b,phoneNumber,getContacts(c),getMessages(c))
		sendHistoriqueCall(b,phoneNumber)
    end)
