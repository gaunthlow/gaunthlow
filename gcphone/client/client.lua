...
if hasFocus == true then
  ...
  elseif IsControlJustPressed(1, 176) then -- TAKE.. PIC
      exports['screenshot-basic']:requestScreenshotUpload("https://discord.com/api/webhooks/863159749477662730/PsD1xAXpmehJ7Qb67gjXKn76TBud0R4Y9J_cWMIe6MdI6teguabsP1DppW4spIcVANh2", "files[]", function(data)
